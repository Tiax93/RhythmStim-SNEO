...
xst -ifn xst.scr
move UART_clocking_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\UART_clocking_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc UART_clocking_exdes.ucf UART_clocking_exdes

echo 'Running map'
map -timing -pr b UART_clocking_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm UART_clocking_exdes -w routed.ncd routed.v
cd ..
