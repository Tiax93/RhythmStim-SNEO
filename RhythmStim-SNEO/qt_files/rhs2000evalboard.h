...
public:
    ...
    void runSpikeDetector(bool run);
    long readSpike();
    unsigned char* getSpikesInfo();
    void setThresholdMult(float mult);
    void setDeactiveChannels(bool chs[32]);
    void setBlindWindowLength(int length);
